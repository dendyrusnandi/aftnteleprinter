...
public class PrintAction {
    ...
    public void open(Display dsp,String filename) throws IOException {
		  ...
		  shell.setText("Print Text123");
	      shell.setMaximized(true);
//	      if (filename.compareTo("")!=0) {
//	    	  textToPrint=openfile(filename);
	    	  filenamec=filename;
//	      }
//	      font = new Font(display, "Courier", 8, SWT.NORMAL);
    }
...
//		  System.out.println("isi data\n" + ReadFromFile.ReadInputFile2(filenamec) + "#");
////	  	  percobaan
//		  PrintDialog dialog = new PrintDialog(shell, SWT.NULL);
//		  PrinterData data = dialog.open();//Printer.getDefaultPrinterData();
//		  if (data == null) {
...
//				  System.out.println("isi data yang akan di print\n" + ReadFromFile.ReadInputFile2(filenamec) + "#");
//	 	    	 
//				  String testString = ReadFromFile.ReadInputFile2(filenamec);//"Hello World!";
